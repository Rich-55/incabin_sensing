...
from DMS_Utils import resize


EYES_LMS_NUMS = [33, 133, 160, 144, 158, 153, 362, 263, 385, 380, 387, 373] # Right: [0-5], left: [6-11]
LEFT_IRIS_NUM = 468
RIGHT_IRIS_NUM = 473
...
class EyeDetector:
    ...
    def get_Gaze_Score(self, frame, landmarks, frame_size):
        ...
        return avg_gaze_score, left_gaze_score, right_gaze_score
